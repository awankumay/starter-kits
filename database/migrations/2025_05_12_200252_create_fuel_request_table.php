...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fuel_request', function (Blueprint $table) {
            ...
            // $table->decimal('current_hourmeter', 10, 2)->nullable(); // Hourmeter saat ini
            ...
            $table->string('fuel_indicator_photo')->nullable(); // Foto indikator BBM kendaraan
            // $table->string('hourmeter_photo')->nullable(); // Foto hourmeter kendaraan
            ...
            // Menambahkan foreign key constraint ke operations_units
            $table->foreign('operations_unit_id')->references('id')->on('operations_units')->onDelete('restrict');
